...
def fetch_data():
    ...
    print("--- DIAGNOSTICO DE LLAVES SECRETAS ---")
    if not corro_key:
        print("❌ ERROR: No se encontro el secret KLAVIYO_API_KEY_CORRO en GitHub.")
    else:
        print("✅ KLAVIYO_API_KEY_CORRO leida correctamente.")
        
    if not cavali_key:
        print("❌ ERROR: No se encontro el secret KLAVIYO_API_KEY_CAVALI en GitHub.")
    else:
        print("✅ KLAVIYO_API_KEY_CAVALI leida correctamente.")
    print("--------------------------------------")
